...
set lines=48 columns=212                                    " set the default size of the vim window
...
if (has("gui_running"))                                     " used for font, but it doesn't work for this macbook pro
    set guifont=Consolas\ Vera\ Sans\ Mono\ 13
    set guifont=Menlo-regular:h16                           " used for MacVim, solved the problem you can set font directly.
endif
